...
This repository contains research harnesses and written findings, not
production software. There are no supported or versioned releases.

Security reports are still welcome: harness scripts execute agent-driven
...
that vendor before publishing, and we ask replicators to do the same.
