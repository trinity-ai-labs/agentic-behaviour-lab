...
const probeVersion = (executor: CommandExecutor.CommandExecutor, bin: string): Effect.Effect<string> =>
...
export type AdapterMap = Readonly<
  Record<string, Layer.Layer<AgentAdapter, never, CommandExecutor.CommandExecutor | FileSystem.FileSystem>>
>
