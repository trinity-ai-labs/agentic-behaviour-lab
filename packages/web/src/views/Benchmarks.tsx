...
export const Benchmarks = () => {
  ...
  const scenario = createMemo(() =>
    scenariosQuery.data?.find((s) => s.scenarioId === scenarioId()),
  );
      ...
      <div class={styles.headerRow}>
        <div>
          ...
          <p class={styles.subtitle}>
            Same scenario, same prompt — rates compared side by side per model × harness.
          </p>
        </div>
        <VerdictLegend />
      </div>
                      ...
                      <Show
                        ...
                        fallback={
                          <p class={shared.status}>
                            No trials run for this scenario yet — start one from Scenarios.
                          </p>
                        }
                      >
